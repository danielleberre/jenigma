...
public class TestEnigma {
    ...
    public void testIdentity() {
        DLBEnigma enigma = new DLBEnigma(RealRotor.IDENTITY1,RealRotor.IDENTITY2,RealRotor.IDENTITY3,Reflector.IDENTITY);
        enigma.setKey('A', 'A', 'A');
        assertEquals("AAA",enigma.getKey());
        enigma.push("AAAAA");
        assertEquals("AAF",enigma.getKey());
    ...
    public void doubleRotorChangeBis() {
        // taken from http://users.telenet.be/d.rijmenants/en/enigmatech.htm#steppingmechanism
    ...
    @Test
    public void testDLB() {
        DLBEnigma enigma = new DLBEnigma(RealRotor.II,RealRotor.III,RealRotor.I,Reflector.REFLECTOR_B);
        enigma.setKey('A', 'A', 'A');
        enigma.push("TROPXFORTEXCETTEXMACHINE");
        System.out.println(enigma.getEncryptedMessage());
    }
}
