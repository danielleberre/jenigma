...
public class Reflector implements RightToLeft, InOutNext {
    ...
    public static final Reflector REFLECTOR_A = new Reflector("EJMZALYXVBWFCRQUONTSPIKHGD");
    public static final Reflector REFLECTOR_B = new Reflector("YRUHQSLDPXNGOKMIEBFZCWVJAT");
    public static final Reflector REFLECTOR_C = new Reflector("FVPJIAOYEDRZXWGCTKUQSBNMHL");
    public static final Reflector REFLECTOR_B_THIN = new Reflector("ENKQAUYWJICOPBLMDXZVFTHRGS");
    public static final Reflector REFLECTOR_C_THIN = new Reflector("RDOBJNTKVEHMLFCWZAXGYIPSUQ");

    public static final Reflector IDENTITY = new Reflector("ABCDEFGHIJKLMNOPQRSTUVWXYZ");
