...
/**
 * Une vue simplifiée de la machine
 * <a href="http://fr.wikipedia.org/wiki/Enigma_(machine)">enigma</a>, sans
 * tableau de permutations.
 * 
 * Des détails sur les différents rotors (substitutions) utilisées sur les
 * différents modèles sont
 * <a href="http://en.wikipedia.org/wiki/Enigma_rotor_details">disponibles en
 * ligne</a>.
 * 
 ...
 * 
 * On ne prendra pas en compte la possibilité de décaler les permutations des
 * rotors.
 * 
...
public interface Enigma {
     ...
     * @param rotorNumber un nombre entier positif, entre 1 et 8 pour les rotors
     *                    officiels.
     */
     ...
     * 
     * @param pos l'emplacement du rotor
     ...
     * 
     * @param pos    la position du rotor concerné
     * @param letter une lettre majuscule, de 'A' à 'Z'.
     */
    ...
    /**
     * Retourne de manière compacte les lettres correspondant aux rotors. Un rotor
     * absent est représenté par un espace.
     * 
     ...
     * Encode une lettre.
     * 
     * Toute la complexité de la machine enigma est cachée derrière cette méthode.
     * 
     * @param c une lettre entre 'A' et 'Z'. Tout autre caractère sera représenté
     *          par un 'X'.
