...
public class RealRotor implements Rotor, Transferable {
	...
	public static final RealRotor III = new RealRotor("III",3,
			"BDFHJLCPRTXVZNYEIWGAKMUSQO", 'V');
	public static final RealRotor IV = new RealRotor("IV",4,
			"ESOVPZJAYQUIRHXLNFTGKDCMWB", 'J');
	public static final RealRotor V = new RealRotor("V",5,
			"VZBRGITYUPSDNHLXAWMJQOFECK", 'Z');
	public static final RealRotor VI = new DoubleAdvanceRotor("VI",6,
			"JPGVOUMFYQBENHZRDKASXLICTW", 'Z', 'M');
	public static final RealRotor VII = new DoubleAdvanceRotor("VII",7,
	...
	public static class DoubleAdvanceRotor extends RealRotor {
		...
		public DoubleAdvanceRotor(String name, int number, String assignment, char changerOne,
				char changerTwo) {
			super(name, number, assignment, changerOne);
			if (changerOne == changerTwo) {
				throw new IllegalArgumentException(
						"Changer positions must be different");
			}
